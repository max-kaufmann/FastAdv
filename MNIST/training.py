...
def get_args():
    ...
    parser.add_argument('--pgd_steps_train',default=40,type=int)
    parser.add_argument('--seed', default=None, type=int)
    parser.add_argument('--dir',default="./",type=str)
    parser.add_argument('--name', default=None, type=str)
    parser.add_argument('--alpha_test', default=0.01, type=float)
    ...
    parser.add_argument('--sampling_method',default='drop_extremes',choices=["drop_extremes","random","high","loss"])
...
def set_args(args):
    ...
    if args.name is None:
        args.name = f"MNIST_{args.training}_e{args.epochs}_b{args.batch_size}_p_{args.data_proportion}"
    ...
    config.test_dataloader = models.get_mnist_train_dataloader(args)
...
def main():
    ...
    dataloader = models.get_mnist_train_dataloader(args)
