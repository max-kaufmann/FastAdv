...
def get_mnist_train_dataloader(args):
    ...
    data_proportion = 1.
    training_dataset = IndexDataset(torchvision.datasets.MNIST("../data/MNIST_test", train=True, download=True, transform=transform))
...
def get_mnist_test_dataloader(args):
    ...
    test_dataset = IndexDataset(torchvision.datasets.MNIST("../data/MNIST_test", train=False, download=True, transform=transform))
